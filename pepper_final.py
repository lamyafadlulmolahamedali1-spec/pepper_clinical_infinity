#!/usr/bin/env python3
"""
PEPPER CLINICAL INFINITY - FINAL WORKING VERSION
...
def generate_counting_task():
    ...
    # Make sure options are between 1-10
...
MOTOR_ACTIONS = [
    {"id": "clap", "name": "👏 CLAP HANDS", "action": "clap", "type": "motor",
     "instruction": "Clap your hands!", "success": "Great clapping!", "tokens": 3},
    {"id": "wave", "name": "👋 WAVE", "action": "wave", "type": "motor",
     "instruction": "Wave your hand!", "success": "Nice wave!", "tokens": 3},
    {"id": "raise_hand", "name": "✋ RAISE HAND", "action": "raise_hand", "type": "motor",
     "instruction": "Raise your hand up!", "success": "Hand raised!", "tokens": 3},
    {"id": "touch_nose", "name": "👆 TOUCH NOSE", "action": "touch_nose", "type": "motor",
     "instruction": "Touch your nose!", "success": "You touched your nose!", "tokens": 4},
    {"id": "arms_out", "name": "🤸 ARMS OUT", "action": "arms_out", "type": "motor",
     "instruction": "Spread your arms wide!", "success": "Arms wide open!", "tokens": 4},
]

def generate_motor_task():
    """Generate random motor task"""
    task = random.choice(MOTOR_ACTIONS).copy()
    task["id"] = f"motor_{task['action']}_{random.randint(1,100)}"
    task["name"] = task["name"]
    return task
...
def generate_speech_task():
    ...
    return {
        "id": f"speech_{word}_{random.randint(1,100)}",
        "name": f"🗣️ Say '{word}'",
        "domain": "Speech",
        "type": "speech",
        "target": word,
...
def generate_infinite_task():
    ...
    task_type = random.choice(["counting", "counting", "motor", "speech"])
...
class MainWindow(QMainWindow):
    ...
    def process_speech(self):
        ...
        if self.speech_card:
            self.speech_card.record_btn.setText("🎤 PRESS & SPEAK 🎤")
