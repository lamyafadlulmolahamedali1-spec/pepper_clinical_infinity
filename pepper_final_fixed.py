#!/usr/bin/env python3
"""
PEPPER FINAL FIXED - نسخة معدلة لتجنب مشكلة GUI
"""
    ...
    while True:
        try:
            ...
            if cmd == 'q':
                ...
                speak("Hello! I'm Pepper in the center!")
                move_head(pepper)
            elif cmd == 'w':
                wave(pepper)
                speak("Hello!")
                ...
                speak("I see walls, table, chairs, cabinet, mirror, balloons, and colorful geometric people!")
            else:
...
# ========== الرئيسي ==========
print("="*60)
print("🤖 PEPPER IN CENTER - نسخة مستقرة")
print("="*60)

# التأكد من إغلاق أي اتصال سابق
try:
    p.disconnect()
except:
    pass
...
for i in range(6):
    ...
    person = GeometricPerson(x, y, colors_list[i], f"P{i+1}")
...
speak("Hello! I am Pepper in the center!")
