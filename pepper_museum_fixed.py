...
class PepperMuseumFixed:
    def __init__(self):
        print("🚀 تشغيل Pepper في متحف العلماء (نسخة مثبتة)...")
        ...
        # تحميل العلماء (كل الصور بنفس الحجم)
        ...
        self.speak("Welcome to the scientist museum!")
    ...
    def load_scientists(self):
        """تحميل العلماء مع صور موحدة الحجم"""
        scientists = []
        ...
        data = [
            {'name': 'Albert Einstein', 'key': 'einstein', 'facts': ['E=mc²', 'Relativity', 'Nobel Prize', 'German physicist']},
            {'name': 'Marie Curie', 'key': 'marie_curie', 'facts': ['Radium', 'Two Nobels', 'Radioactivity', 'Polish scientist']},
            {'name': 'Isaac Newton', 'key': 'newton', 'facts': ['Gravity', 'Laws of Motion', 'Calculus', 'English physicist']},
            {'name': 'Nikola Tesla', 'key': 'tesla', 'facts': ['AC Current', 'Tesla Coil', 'Wireless', 'Serbian inventor']},
            {'name': 'Stephen Hawking', 'key': 'hawking', 'facts': ['Black Holes', 'Time', 'ALS', 'British cosmologist']}
        ]
    ...
    def create_image_window(self):
        ...
        self.img_height = 450
        self.spacing = 30
        self.gallery_width = len(self.scientists) * (self.img_width + self.spacing) + 50
        self.gallery = np.ones((self.img_height + 100, self.gallery_width, 3), dtype=np.uint8) * 255
    ...
    def run(self):
        print("\n" + "="*70)
        print("🌟 Pepper في متحف العلماء - جميع الصور بنفس الحجم")
        print("="*70 + "\n")
        
        self.speak("Look at the gallery!")
