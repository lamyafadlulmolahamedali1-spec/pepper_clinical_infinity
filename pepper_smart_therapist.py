...
"""
╔══════════════════════════════════════════════════════════════════╗
║  PEPPER SMART THERAPIST                                         ║
║  pepper_smart_therapist.py                                      ║
║  Commander: Lamya | Omdurman Islamic University                 ║
╠══════════════════════════════════════════════════════════════════╣
║  ✅ ALL Qt UI via pyqtSignal — zero threading violations        ║
║  ✅ Conscious task loop: check → celebrate → next task         ║
║  ✅ MediaPipe joint angles for motor validation                 ║
║  ✅ Visual modeling HD + large ✅ on success                    ║
║  ✅ energy_threshold=300 — no ghost speech                     ║
║  ✅ gemini-1.5-flash stable                                     ║
║  ✅ No DeepFace — MediaPipe-only emotion                       ║
║  ✅ Lip-sync HeadPitch + avatar mouth                          ║
╚══════════════════════════════════════════════════════════════════╝
"""
...
os.environ.update({
    ...
    # Suppress cuDNN double-register (non-fatal)
...
# ═══════════════════════════════════════════════════════════════
# 3. TASK LIBRARY
#    Each task has a clear check type, visual model, and next-task logic
...
TASKS = [
    ...
    {
        "id": "clap",
        "domain": "Motor", "level": 1, "protocol": "ABA-Motor",
        "instruction": "Look at the screen and CLAP your hands!",
        "waiting_msg": "I am waiting for you to clap! 👏",
        "success_msg": "Amazing! You clapped correctly! You did the move! ✅",
        "fail_msg": "Not quite! Try again — clap your hands together!",
        "verify": "motor",
        "motor_check": "clap",
        "tablet_mode": "motor_model",
        "motor_emoji": "👏", "motor_label": "CLAP HANDS",
        "motor_desc": "Bring both palms together and make a sound!",
        "prompts": ["Clap your hands!", "Hands together!", "Like this! *clap*"],
        "tokens": 2, "joy": "dance",
    },
    {
        "id": "wave",
        ...
        "waiting_msg": "I am waiting for you to wave! 👋",
        "success_msg": "Amazing! You waved! Perfect movement! ✅",
        "fail_msg": "Not quite! Try again — wave your hand side to side!",
        "verify": "motor", "motor_check": "wave",
        "tablet_mode": "motor_model",
        "motor_emoji": "👋", "motor_label": "WAVE HELLO",
        "motor_desc": "Move your hand from left to right — say hello!",
    ...
    },
    {
        ...
        "waiting_msg": "I am waiting for you to raise your hand! ✋",
        "success_msg": "Amazing! Your hand is up high! You did it! ✅",
        "fail_msg": "Not quite! Lift your arm up above your head!",
        "verify": "motor", "motor_check": "raise_hand",
        "tablet_mode": "motor_model",
        "motor_emoji": "✋", "motor_label": "RAISE HAND",
        "motor_desc": "Lift your arm up — higher than your shoulder!",
        "prompts": ["Hand up!", "Reach high!", "Arm up above head!"],
    ...
    },
    {
        ...
        "waiting_msg": "I am waiting — touch your nose with your finger! 👆",
        "success_msg": "Amazing! You touched your nose! So smart! ✅",
        "fail_msg": "Not quite! Point your finger to your nose!",
        "verify": "motor", "motor_check": "touch_nose",
        "tablet_mode": "motor_model",
        "motor_emoji": "👆👃", "motor_label": "TOUCH NOSE",
        "motor_desc": "Point your finger and touch the tip of your nose!",
    ...
    },
    {
        ...
        "waiting_msg": "Stretch both arms wide like an airplane! 🤸",
        "success_msg": "Amazing! Great big stretch! Like an airplane! ✅",
        "fail_msg": "Not quite! Spread both arms wide to the sides!",
        "verify": "motor", "motor_check": "arms_out",
        "tablet_mode": "motor_model",
        "motor_emoji": "🤸", "motor_label": "ARMS OUT WIDE",
        "motor_desc": "Spread both arms out to the sides like an airplane!",
        "prompts": ["Arms out wide!", "Like an airplane!", "Both arms to the sides!"],
        "tokens": 2, "joy": "dance",
    },
    {
        "id": "both_hands_up",
        ...
        "waiting_msg": "Put both hands up high! 🙌",
        "success_msg": "Amazing! Both hands up! You are a superstar! ✅",
        "fail_msg": "Not quite! Lift BOTH arms above your head!",
        "verify": "motor", "motor_check": "hands_up",
        "tablet_mode": "motor_model",
        "motor_emoji": "🙌", "motor_label": "BOTH HANDS UP",
        "motor_desc": "Raise BOTH arms high above your head!",
        "prompts": ["Both hands up!", "Two arms high!", "Up up up!"],
        "tokens": 2, "joy": "celebrate",
    },
    # ── COGNITIVE: COLORS ─────────────────────────────────────
    {
        "id": "color_red",
        "domain": "Cognitive", "level": 2, "protocol": "TEACCH-Visual",
        "instruction": "Where is the RED color? Click on it!",
        "waiting_msg": "I am waiting — click the RED circle! 🔴",
        "success_msg": "Correct! You found RED! Brilliant! ✅",
        "fail_msg": "Not quite, try again! Find the RED circle!",
        "verify": "tablet_click",
    ...
    },
    {
        "id": "color_blue",
        "domain": "Cognitive", "level": 2, "protocol": "TEACCH-Visual",
        "instruction": "Where is the BLUE color? Click on it!",
        "waiting_msg": "Click the BLUE circle! 🔵",
        "success_msg": "Correct! You found BLUE! Amazing! ✅",
        "fail_msg": "Not quite! Find the BLUE circle and click it!",
        ...
        "correct": 1, "tokens": 3, "joy": "dance",
    },
    {
        "id": "color_green",
        "domain": "Cognitive", "level": 2, "protocol": "TEACCH-Visual",
        "instruction": "Where is GREEN? Click on it!",
        "waiting_msg": "Click the GREEN circle! 🟢",
        "success_msg": "Correct! GREEN! You are so clever! ✅",
        "fail_msg": "Not quite! Find GREEN and click!",
        "verify": "tablet_click", "tablet_mode": "color_grid",
        "options": [
            {"color": "#eab308", "label": "YELLOW"},
            {"color": "#ef4444", "label": "RED"},
        ...
        "correct": 2, "tokens": 3, "joy": "celebrate",
    },
    {
        "id": "color_yellow",
        "domain": "Cognitive", "level": 2, "protocol": "TEACCH-Visual",
        "instruction": "Where is YELLOW? Click on it!",
        "waiting_msg": "Click the YELLOW circle! 🟡",
        "success_msg": "Correct! YELLOW like sunshine! ✅",
        "fail_msg": "Not quite! Find the YELLOW color!",
        "verify": "tablet_click", "tablet_mode": "color_grid",
        "options": [
            {"color": "#eab308", "label": "YELLOW"},
            {"color": "#a855f7", "label": "PURPLE"},
    ...
    {
        "id": "animal_dog",
        "domain": "Cognitive", "level": 3, "protocol": "TEACCH-Visual",
        "instruction": "Where is the DOG? Click on it!",
        "waiting_msg": "Find the DOG and click it! 🐶",
        "success_msg": "Correct! That is a dog — woof woof! ✅",
        "fail_msg": "Not quite! Look carefully — find the dog!",
    ...
    },
    {
        "id": "animal_cat",
        "domain": "Cognitive", "level": 3, "protocol": "TEACCH-Visual",
        "instruction": "Where is the CAT? Click on it!",
        "waiting_msg": "Find the CAT! 🐱",
        "success_msg": "Correct! That is the cat — meow! ✅",
        "fail_msg": "Not quite! Find the cat!",
        "verify": "tablet_click", "tablet_mode": "object_grid",
        "options": [
            {"emoji": "🐶", "label": "Dog"},
            {"emoji": "🐱", "label": "Cat"},
    ...
    },
    {
        "id": "animal_lion",
        "domain": "Cognitive", "level": 3, "protocol": "TEACCH-Visual",
        "instruction": "Where is the LION? Click on it!",
        "waiting_msg": "Find the LION — the king! 🦁",
        "success_msg": "Correct! The lion — king of the jungle! ✅",
        "fail_msg": "Not quite! Find the lion!",
        "verify": "tablet_click", "tablet_mode": "object_grid",
        "options": [
    ...
    },
    {
        "id": "animal_elephant",
        "domain": "Cognitive", "level": 3, "protocol": "TEACCH-Visual",
        "instruction": "Where is the ELEPHANT? Click on it!",
        "waiting_msg": "Find the big ELEPHANT! 🐘",
        "success_msg": "Correct! The big elephant! ✅",
        "fail_msg": "Not quite! Find the elephant!",
        "verify": "tablet_click", "tablet_mode": "object_grid",
        "options": [
            {"emoji": "🐘", "label": "Elephant"},
            {"emoji": "🦊", "label": "Fox"},
    ...
    {
        "id": "fruit_apple",
        "domain": "Cognitive", "level": 4, "protocol": "TEACCH-Visual",
        "instruction": "Where is the APPLE? Click on it!",
        "waiting_msg": "Find the APPLE! 🍎",
        "success_msg": "Correct! That is an apple! ✅",
        "fail_msg": "Not quite! Find the apple!",
        "verify": "tablet_click", "tablet_mode": "object_grid",
        "options": [
            {"emoji": "🍎", "label": "Apple"},
            {"emoji": "🍌", "label": "Banana"},
    ...
    },
    {
        "id": "fruit_banana",
        "domain": "Cognitive", "level": 4, "protocol": "TEACCH-Visual",
        "instruction": "Where is the BANANA? Click on it!",
        "waiting_msg": "Find the BANANA! 🍌",
        "success_msg": "Correct! That is a banana! ✅",
        "fail_msg": "Not quite! Find the banana!",
        "verify": "tablet_click", "tablet_mode": "object_grid",
        "options": [
            {"emoji": "🍎", "label": "Apple"},
            {"emoji": "🍌", "label": "Banana"},
    ...
    {
        "id": "shape_circle",
        "domain": "Cognitive", "level": 5, "protocol": "TEACCH-Visual",
        "instruction": "What shape is this? Click the CIRCLE!",
        "waiting_msg": "Find the round CIRCLE! ⭕",
        "success_msg": "Correct! That is a circle — round and perfect! ✅",
        "fail_msg": "Not quite! Find the round circle!",
    ...
    },
    {
        "id": "shape_square",
        "domain": "Cognitive", "level": 5, "protocol": "TEACCH-Visual",
        "instruction": "What shape is this? Click the SQUARE!",
        "waiting_msg": "Find the SQUARE — four equal sides! ⬛",
        "success_msg": "Correct! That is a square! ✅",
        "fail_msg": "Not quite! Find the square with 4 equal sides!",
        "verify": "tablet_click", "tablet_mode": "shape_grid",
        "options": [
            {"emoji": "🔺", "label": "Triangle"},
            {"emoji": "⭕", "label": "Circle"},
    ...
    {
        "id": "number_1",
        "domain": "Cognitive", "level": 5, "protocol": "DTT-Verbal",
        "instruction": "Click on the number ONE!",
        "waiting_msg": "Find number 1! 1️⃣",
        "success_msg": "Correct! That is number ONE! ✅",
        "fail_msg": "Not quite! Find the number 1!",
    ...
    },
    {
        ...
        "waiting_msg": "Find number 3! 3️⃣",
        "success_msg": "Correct! That is number THREE! ✅",
        "fail_msg": "Not quite! Find the number 3!",
        "verify": "tablet_click", "tablet_mode": "number_grid",
        "options": [
            {"num": "5", "label": "Five"},
            {"num": "2", "label": "Two"},
    ...
    {
        "id": "say_apple",
        "domain": "Verbal", "level": 6, "protocol": "DTT-Verbal",
        "instruction": "Say the word APPLE out loud!",
        "waiting_msg": "I am listening — say APPLE! 🍎",
        "success_msg": "Correct! You said APPLE! Wonderful voice! ✅",
        "fail_msg": "Not quite! Say: Apple!",
    ...
    },
    {
        "id": "say_blue",
        "domain": "Verbal", "level": 6, "protocol": "DTT-Verbal",
        "instruction": "What color is the sky? Say BLUE!",
        "waiting_msg": "I am listening — say BLUE! 🔵",
        "success_msg": "Correct! BLUE like the sky! ✅",
        "fail_msg": "Not quite! The sky is BLUE — say it!",
        "verify": "speech_keyword", "keyword": "blue",
        "tablet_mode": "word_display",
        "word_emoji": "🔵", "word_text": "BLUE",
        "prompts": ["Say Blue!", "Blue sky!", "Repeat: Blue!"],
        "tokens": 4, "joy": "dance",
    },
    {
        "id": "say_name",
        "domain": "Verbal", "level": 6, "protocol": "DTT-Verbal",
        "instruction": "Tell me your name! What is your name?",
        "waiting_msg": "I am listening — tell me your name! 👦",
        "success_msg": "Wonderful! I love your name! ✅",
        "fail_msg": "Try again! Say your name out loud!",
        "verify": "speech_any",
        "tablet_mode": "word_display",
    ...
    },
    {
        ...
        "waiting_msg": "Count 1, 2, 3! I am listening! ⭐⭐⭐",
        "success_msg": "Correct! You counted to 3! Brilliant! ✅",
        "fail_msg": "Not quite! Say: 1, 2, 3!",
        "verify": "speech_number",
        "tablet_mode": "word_display",
        "word_emoji": "⭐⭐⭐", "word_text": "1, 2, 3",
        "prompts": ["Count!", "1, 2, 3...", "Three numbers!"],
        "tokens": 5, "joy": "celebrate",
    },
    # ── SOCIAL ────────────────────────────────────────────────
    {
        "id": "full_sentence",
        "domain": "Social", "level": 7, "protocol": "ESDM-Social",
        "instruction": "Tell me something you love! Use a full sentence!",
        "waiting_msg": "I am listening — tell me what you love! 💬",
        "success_msg": "Wonderful! I love hearing about you! ✅",
        "fail_msg": "Try again! Tell me: I love...",
    ...
    },
    {
        "id": "how_feel",
        "domain": "Social", "level": 7, "protocol": "ESDM-Social",
        "instruction": "How do you feel today? Click your face!",
        "waiting_msg": "Click how you feel today! 😊",
        "success_msg": "Thank you for telling me how you feel! ✅",
        "fail_msg": "Try again! Click the face that shows how you feel!",
...
class EmpathyLib:
    _lib = {
        ...
        "angry":      ["It is okay. I am patient. [NOD]", "Let us calm. [HUG]"],
        ...
        "task_retry": ["Not quite! Try again! 🎯",
                       "Almost there! You can do it! 🎯", "One more time! 🎯"],
        "level_up":   ["LEVEL UP! [DANCE][CELEBRATE]", "CHAMPION! [CELEBRATE]"],
        "youtube":    ["Video reward! What to watch? 🎬", "Tell me your favorite! 🎬"],
        "waiting":    ["I am waiting for you! Take your time. 🎯",
...
# ═══════════════════════════════════════════════════════════════
# 6. TABLET SIGNALS — ALL UI updates go through here
#    This is the ONLY way background threads touch the UI
# ═══════════════════════════════════════════════════════════════
class TabletBridge(QObject):
    """
    CRITICAL FIX: Every single Qt UI operation from a background thread
    MUST go through these signals. Direct label.setText() from threads = crash.
    """
    # Task display signals
    sig_new_task        = pyqtSignal(dict)   # show new task
    sig_show_success    = pyqtSignal(str)    # large ✅ + message
    sig_show_fail       = pyqtSignal(str)    # ❌ + message
    sig_unlock          = pyqtSignal()       # unlock cards
    sig_lock            = pyqtSignal()       # lock cards
    sig_set_feedback    = pyqtSignal(str)    # feedback text
    sig_set_instruction = pyqtSignal(str)    # instruction text
    sig_set_waiting     = pyqtSignal(str)    # "I am waiting..." text
    sig_reset_cards     = pyqtSignal()       # reset card colors
    sig_joy             = pyqtSignal(str)    # social joy animation
    sig_update_stats    = pyqtSignal()       # refresh stats
...
class ClickCard(QPushButton):
    ...
    def _set_normal(self):
        ...
        if m == "color_grid":
            ...
            QPushButton{{background:{d['color']};border-radius:79px;
            ...
            self.setFont(QFont("Arial", max(10,sz//7), QFont.Weight.Bold))
            self.setStyleSheet("""
            ...
            QPushButton:hover{border:4px solid #a78bfa;background:#2e2b6e;}""")
        elif m == "number_grid":
    ...
    def _on_click(self):
        ...
        # Emit through bridge — safe from any thread context
        # (This click is already on main thread since it's a Qt signal)
        BRIDGE.sig_new_task.emit({"action": "click", "idx": self.idx})


# ═══════════════════════════════════════════════════════════════
# 8. TABLET WINDOW — FIXED 740×960
# ═══════════════════════════════════════════════════════════════
class TabletWindow(QMainWindow):
    def __init__(self):
        ...
        # Stats refresh — safe on main thread
    ...
    def _setup_ui(self):
        ...
        self.av_lbl = QLabel("🤖")
        self.av_lbl.setFont(QFont("Arial", 28))
        ...
        sched = QFrame(); sched.setFixedHeight(56)
        ...
        stars_w = QWidget(); sl2 = QVBoxLayout(stars_w)
        sl2.setSpacing(1); sl2.setContentsMargins(0, 0, 0, 0)
        ...
        self.mastery_sub = QLabel("0 / 3 correct")
        ...
        # ── DOMAIN BADGE ──────────────────────────────────────
        self.domain_badge = QLabel("🏃 Motor Domain")
        ...
        # ── INSTRUCTION ───────────────────────────────────────
        if_ = QFrame(); if_.setFixedHeight(94)
        ...
        # ── FEEDBACK ──────────────────────────────────────────
        ff = QFrame(); ff.setFixedHeight(62)
        ...
        self.fb_lbl.setFont(QFont("Arial", 12, QFont.Weight.Bold))
    ...
    def _connect_bridge(self):
        """
        Connect all bridge signals to slots.
        ALL connections run on main thread automatically.
        """
        ...
        BRIDGE.sig_set_instruction.connect(self._set_instruction)
    ...
    def _refresh_stats(self):
        """Safe stat update — only called on main thread via timer or signal"""
        ...
        n = ST["consecutive"]
        filled = "⭐" * n; empty = "☆" * (3 - n)
        self.stars_lbl.setText(f"{filled}{empty}" if n > 0 else "☆ ☆ ☆")
        self.mastery_sub.setText(f"{n} / 3 correct")
        star_colors = {0: "#4b5563", 1: "#d97706", 2: "#fbbf24", 3: "#f59e0b"}
        self.stars_lbl.setStyleSheet(f"color:{star_colors.get(n,'#4b5563')};")
        # Task schedule
    ...
    def _on_new_task(self, data):
        """Handle new task or click event — always on main thread"""
    ...
    def _build_content(self, data):
        ...
        if mode == "motor_model":
            ...
            em.setFont(QFont("Arial", 100))
            em.setAlignment(Qt.AlignmentFlag.AlignCenter)
            vl.addWidget(em)
            tl = QLabel(data.get("label", ""))
            tl.setFont(QFont("Arial", 18, QFont.Weight.Bold))
            tl.setStyleSheet("color:#a78bfa;")
            tl.setAlignment(Qt.AlignmentFlag.AlignCenter)
            vl.addWidget(tl)
            dl = QLabel(data.get("desc", ""))
            dl.setFont(QFont("Arial", 12))
            dl.setStyleSheet("color:#9ca3af;")
        ...
        if mode == "word_display":
            ...
            wl.setFont(QFont("Arial", 34, QFont.Weight.Bold))
            wl.setStyleSheet("color:#a78bfa;")
            wl.setAlignment(Qt.AlignmentFlag.AlignCenter)
            wfl.addWidget(wl)
            hl2 = QLabel("🎤 Say it out loud!")
            hl2.setFont(QFont("Arial", 13))
        ...
        if hint:
            hl3 = QLabel(f"💡 {hint}")
            hl3.setFont(QFont("Arial", 11))
            hl3.setStyleSheet("color:#60a5fa;")
            hl3.setAlignment(Qt.AlignmentFlag.AlignCenter)
            self.content_lay.addWidget(hl3)
    ...
    def _handle_click(self, idx):
        """Process child's click — on main thread"""
        if self._locked: return
        correct = self._correct_idx
        if correct == -1:  # Free choice (emotion task)
    ...
    def _on_success_overlay(self, msg):
        ...
        check = QLabel("✅")
        check.setFont(QFont("Arial", 120))
        check.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ol.addWidget(check)
        ml = QLabel(msg)
        ml.setFont(QFont("Arial", 16, QFont.Weight.Bold))
        ml.setStyleSheet("color:#34d399;")
        ml.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ml.setWordWrap(True)
        ol.addWidget(ml)
        stars = QLabel("⭐" * min(3, ST["consecutive"]))
        stars.setFont(QFont("Arial", 28))
    ...
    def _on_joy(self, joy_type):
        ...
        msgs = {
            ...
            "wave_back": "👋 HIGH FIVE! 🌟",
            "full_joy": "🏆 YOU ARE A CHAMPION! 🎉🎊🌟",
        }
        self.fb_lbl.setText(msgs.get(joy_type, "🌟 AMAZING! 🎉"))
    ...
    def _set_feedback(self, txt):
        self.fb_lbl.setText(txt)

    def _set_instruction(self, txt):
        self.instr_lbl.setText(txt)
...
# ═══════════════════════════════════════════════════════════════
# 9. GEMINI — gemini-1.5-flash stable
# ═══════════════════════════════════════════════════════════════
CLINICAL_PROMPT = """You are PEPPER, a Clinical ASD Therapist robot.
Developer: Lamya (Omdurman Islamic University).

PROTOCOLS: ABA, TEACCH, DTT, ESDM

CONSCIOUS TASK LOGIC:
- Check child response BEFORE moving to next task
- If correct: celebrate specifically and say you are moving to next task
- If incorrect: say "Not quite, try again!" and STAY on current task
- Always use child's name

MASTERY: 3 consecutive correct → task mastered → next task

RESPONSE: Max 2 sentences. End with task instruction or "Ready? Your turn! 🎯"

TOKENS: [WAVE][CLAP][NOD][DANCE][POINT][HUG][CELEBRATE][THINK][LEVEL_UP]
...
class GeminiBrain:
    ...
    def __init__(self):
        ...
        for mn in self.MODELS:
            try:
                ...
                err = str(e)
                if "403" in err: print(f"⚠️  {mn}: 403 key issue — rotate API key")
                elif "404" in err: print(f"⚠️  {mn}: 404 not found — trying next")
                else: print(f"⚠️  {mn}: {err[:55]}")
    ...
    def _ctx(self):
        ...
        return (f"[child={ST['name']} age={ST['age']} "
                ...
                f"mastery={ST['consecutive']}/3 emotion={ST['emotion']} "
                f"attention={ST['attention']}% streak={ST['streak']} "
                f"ctx={recent}] ")
    ...
    def ask(self, prompt):
        ...
        with self._lock:
            try:
                ...
                if "403" in err: print("⚠️  403: Rotate API key!")
                LOG(f"API: {err[:40]}")
    ...
    def parent_ask(self, q):
        ...
        try:
            ...
            pm = genai.GenerativeModel(self.model_name,
                system_instruction=(
                    "Expert ABA/TEACCH/DTT/ESDM autism specialist for parents. "
...
# ═══════════════════════════════════════════════════════════════
# 10. VISION — MediaPipe only (no DeepFace)
# ═══════════════════════════════════════════════════════════════
...
class VisionEngine:
    ...
    def _detect_pose(self, frame):
        ...
        try:
            ...
            # Joint angles
            l_sh_ang = self._joint_angle(lm[PL.LEFT_ELBOW], lm[PL.LEFT_SHOULDER], lm[PL.LEFT_HIP])
            r_sh_ang = self._joint_angle(lm[PL.RIGHT_ELBOW], lm[PL.RIGHT_SHOULDER], lm[PL.RIGHT_HIP])
            l_el_ang = self._joint_angle(lm[PL.LEFT_SHOULDER], lm[PL.LEFT_ELBOW], lm[PL.LEFT_WRIST])
            r_el_ang = self._joint_angle(lm[PL.RIGHT_SHOULDER], lm[PL.RIGHT_ELBOW], lm[PL.RIGHT_WRIST])
            pl = {
    ...
    def _infer_emotion(self):
        ...
        if ear < 0.20: em = "surprised"
        elif mouth > 0.06: em = "happy"
        elif mouth > 0.04: em = "joyful"
        elif ear < 0.22 and mouth < 0.02: em = "sad"
        else: em = "neutral"
        ST["emotion"] = em
    ...
    def _detect_hands(self, frame):
        ...
        try:
            ...
            if len(lms) >= 2:
                ...
                ST["clapping"] = abs(h1.x - h2.x) < 0.18 and abs(h1.y - h2.y) < 0.18
        except: pass
    ...
    def _validate_motor(self):
        """MediaPipe joint angle motor validation"""
        ...
        if va == "clap": ok = ST["clapping"]
            ...
            fh = fm.get("frame_h", 480); ny = fm.get("nose_y", -1)
            if nx > 0 and pl:
        ...
        if ok:
            ...
            ST["verify_timeout"] = 0.0; LOG("✅ Joint validated!", "success")
    ...
    def _build_emo_win(self, frame):
        ...
        cv2.putText(base, f"{dom} | {'★'*suc}{'☆'*(3-suc)} | {em.upper()}",
            (8,40), cv2.FONT_HERSHEY_SIMPLEX, 0.54, col, 2)
        acts = [("Hand Raised", ST["hand_raised"], (0,255,100)),
        ...
        pl = ST.get("pose_landmarks", {})
        vy = ry + 338
        cv2.putText(base, f"L-elbow:{pl.get('l_elbow_angle',0):.0f}° R-elbow:{pl.get('r_elbow_angle',0):.0f}°",
            (rx, vy), cv2.FONT_HERSHEY_SIMPLEX, 0.36, (180,180,180), 1)
        cv2.putText(base, f"L-shldr:{pl.get('l_shoulder_angle',0):.0f}° R-shldr:{pl.get('r_shoulder_angle',0):.0f}°",
            (rx, vy+16), cv2.FONT_HERSHEY_SIMPLEX, 0.36, (180,180,180), 1)
        if ST["verify_action"]:
            rem = max(0, int(ST["verify_timeout"] - time.time()))
            cv2.rectangle(base, (rx, vy+26), (596, vy+64), (28,14,0), -1)
            cv2.rectangle(base, (rx, vy+26), (596, vy+64), (255,140,0), 2)
            cv2.putText(base, f"Verify: {ST['verify_action']} ({rem}s)",
                (rx+5, vy+50), cv2.FONT_HERSHEY_SIMPLEX, 0.44, (255,160,50), 1)
    ...
    def _build_live_win(self, frame):
        ...
        suc = ST["consecutive"]
        cv2.putText(win, f"★{suc}/3 | Mastered:{ST['tasks_mastered']}",
        ...
        # ESDM: head tracking — look at child
        if ST["gaze_mode"] == "tablet":
            cv2.putText(win, "Looking at tablet ▶", (av_cx-65, av_cy+195),
                cv2.FONT_HERSHEY_SIMPLEX, 0.38, (0,220,200), 1)
        ...
        for ex_ in [av_cx-19, av_cx+19]:
            cv2.ellipse(win, (ex_, hy-9), (7, ey_), 0, 0, 360, (100,180,255), -1)
            if not blink_:
        ...
        if ST["is_speaking"]:
            ...
            cv2.putText(win, "LISTENING",
                (av_cx-42, av_cy+185), cv2.FONT_HERSHEY_SIMPLEX, 0.48, (0,220,100), 2)
        elif ST["waiting_for_child"]:
            cv2.putText(win, "WAITING...",
                (av_cx-42, av_cy+185), cv2.FONT_HERSHEY_SIMPLEX, 0.46, (255,200,0), 1)
        ...
        cv2.putText(win, "LIVE — PEPPER SMART THERAPIST",
        ...
        cv2.putText(win,
            ...
            f"Score:{ST['score']} | ★{ST['consecutive']}/3 | "
            f"{'AI' if ST['gemini_ok'] else 'FB'} | energy={MIC_ENERGY}",
...
# ═══════════════════════════════════════════════════════════════
# 13. MIC — energy=300 (no ghost speech)
# ═══════════════════════════════════════════════════════════════
class Mic:
    def __init__(self):
...
# ═══════════════════════════════════════════════════════════════
# 14. ACTIONS → PYBULLET + LIP-SYNC + GAZE
# ═══════════════════════════════════════════════════════════════
class Actions:
    ...
    def trigger_joy(self, joy_type="celebrate"):
        BRIDGE.sig_joy.emit(joy_type)
        joy_map = {
            "dance": self._dance, "celebrate": self._celebrate,
            "wave_back": self._wave, "full_joy": self._social_joy,
        }
...
# ═══════════════════════════════════════════════════════════════
# 15. PYBULLET (Window 1 — FIXED)
# ═══════════════════════════════════════════════════════════════
class PepperSim:
    def __init__(self):
        self.pepper = None; self.ok = False; self.rx = self.ry = 0.0; self.balloons = []
    ...
    def launch(self):
        try:
            ...
            for fn in [self._sim_loop, self._walk_loop, self._arm_loop]:
                threading.Thread(target=fn, daemon=True).start()
            print("✅ PyBullet Window 1 (FIXED — lip-sync)")
            return self.pepper
        ...
        while True:
            try:
                if ST["is_speaking"]:
                    ...
                    self.pepper.setAngles("HeadYaw", -0.4, .08)
                    self.pepper.setAngles("HeadPitch", 0.1, .08)
                else:
...
class Display:
    ...
    def _sim_frame(self):
        ...
        cv2.circle(f,(w//2,h//2-40),r,(int(50+50*math.sin(t)),int(100+100*math.cos(t*.7)),220),3)
...
<div class="pbox">
  ...
  <a href="https://LamyaFadlulmolaHamedAli.pythonanywhere.com" target="_blank"
     class="btn btn-g" style="display:inline-block;text-decoration:none">Open 🚀</a>
</div>
<script>
var sc=0,lv=1;
...
function start(g){var d=document.getElementById('ag');if(g==='balloons')runBalloons(d);else if(g==='emotions')emoGame(d);else if(g==='colors')colorGame(d);else if(g==='numbers')numGame(d);else if(g==='memory')memGame(d);else shapeGame(d);}
...
<h1>📋 ABA/TEACCH/DTT/ESDM Reports</h1>
<div class="nav">
  <a href="http://127.0.0.1:5007/" class="b1">🧠 Brain</a>
  <a href="http://127.0.0.1:5009/" class="b2">🎮 Games</a>
  <a href="http://127.0.0.1:5001/" class="b3">📋 Reports</a>
...
<title>Pepper Smart Therapist</title><meta http-equiv="refresh" content="3">
...
<div class="sidebar">
  ...
  <div style="text-align:center;padding:5px">
    ...
    <div style="font-size:.58em;color:#a78bfa;margin-top:1px">{{s.gaze_mode}}</div>
  </div>
...
<div class="mastery-box">
  <div style="color:var(--gr);font-size:.80em;font-weight:700">
    ★ {{ task_name }} | {{ s.domain }} | {{ s.consecutive }}/3</div>
  <div style="font-size:1.8em;margin:4px">
...
<div class="hdr">
  ...
  <div><h1>Pepper Smart Therapist — Conscious Task Loop</h1>
    <p style="font-size:.66em;opacity:.8">Commander: <b>Lamya</b> |
      Child: <b>{{s.name}}</b> ({{s.age}}) | {{s.session_start}}</p></div>
...
<div class="row r3">
  <div class="card"><h2>😊 Emotion</h2>
    <div style="text-align:center;padding:4px">
      ...
      {% elif s.waiting_for_child %}<div style="font-size:.63em;color:var(--yl);margin-top:3px">⏳ Waiting</div>
      {% endif %}
    </div>
  </div>
  <div class="card"><h2>🎮 Controls</h2>
    <form method="POST" action="/cmd">
      ...
      <button class="btn" name="c" value="next_task" style="width:100%;margin:2px 0">Skip Task ⏭️</button>
...
<div id="tc-hl" class="tc">
  <div class="row r3">
    <div class="hc"><div class="hct">Conscious Task Loop</div>
      <div class="hcb">Pepper checks response → if correct: celebrate + move to next task. If wrong: "Not quite, try again!" — STAYS on same task. DTT protocol.</div>
      <div class="tip">3 consecutive correct = mastery!</div></div>
    <div class="hc"><div class="hct">Large ✅ on Success</div>
      <div class="hcb">When child succeeds, a LARGE ✅ appears on tablet. Pepper says "Amazing! You did it correctly!"</div>
      <div class="tip">Visual feedback = TEACCH best practice.</div></div>
    <div class="hc"><div class="hct">Qt Thread Safety</div>
      <div class="hcb">ALL UI updates via pyqtSignal. TabletBridge routes everything. Zero QBasicTimer errors.</div>
      <div class="tip">BRIDGE.sig_* for all UI updates.</div></div>
    <div class="hc"><div class="hct">MediaPipe Joint Angles</div>
      <div class="hcb">Shoulder/elbow angles calculated. arms_out = shoulder > 70°. raise_hand = wrist > shoulder + elbow > 120°.</div>
      <div class="tip">No DeepFace — zero TF conflicts.</div></div>
    <div class="hc"><div class="hct">Mic energy={{mic_energy}}</div>
      <div class="hcb">Fixed at 300. No ghost speech. Whisper hallucination from background noise eliminated.</div>
      <div class="tip">Speak clearly near mic for best results.</div></div>
    <div class="hc"><div class="hct">ESDM Head Tracking</div>
      <div class="hcb">Pepper looks at tablet [GAZE_TABLET] then back at child [GAZE_CHILD] creating "awareness".</div>
      <div class="tip">Gaze shown in live window.</div></div>
  </div>
  <div class="card" style="margin-top:7px"><h2>Session Summary</h2>
    <div style="font-size:.69em;color:#9ca3af;line-height:1.8">
      Child:<b style="color:var(--tx)">{{s.name}}</b> | Level {{s.current_level}} | {{s.domain}} | {{s.session_date}}<br>
...
<div id="tc-st" class="tc">
  <div class="row r2">
    ...
    <div class="card"><h2>All Fixes Applied</h2>
      <div style="font-size:.69em;color:var(--mu);line-height:1.9">
        ✅ Qt: pyqtSignal TabletBridge<br>
        ✅ No DeepFace<br>
        ✅ Emotion: MediaPipe FaceMesh<br>
        ✅ Mic energy: {{mic_energy}}<br>
        ✅ Gemini: 1.5-flash stable<br>
        ✅ No breathing tasks<br>
        ✅ Large ✅ on success<br>
        ✅ Conscious check → next task<br>
        ✅ Joint angle validation<br>
...
def brain_catch(path=""):
    ...
    return render_template_string(BRAIN_HTML, s=ST, qqs=QUICK_QS,
        ...
        mic_energy=MIC_ENERGY, whisper_ok=str(WHISPER_OK))
...
# ═══════════════════════════════════════════════════════════════
# 18. THERAPY CONTROLLER — CONSCIOUS TASK LOOP
#     check response → celebrate/correct → then next task
# ═══════════════════════════════════════════════════════════════
class TherapyCtrl:
    ...
    def _say(self, text, wait=True):
        """Speak and update tablet instruction via signal"""
        clean = self.a.process(str(text))
        if self.s.ok: self.s.show_text(clean[:55])
        BRIDGE.sig_set_instruction.emit(clean[:70])
        self.v.say(clean, wait=wait)

    def _ask(self, prompt):
        resp = self.g.ask(prompt); self._say(resp); return resp
    ...
    def run(self):
        ...
        # Greeting
        self._ask(
            f"Child is {name}. Warm greeting! [WAVE] "
            "Explain: copy movements on screen! Click correct images! "
            "3 correct in a row = mastery and next task! "
            "'Ready? Your turn! 🎯'")
        time.sleep(0.5)
        ...
        while self.running:
            ...
            if curr != last_em and time.time() - em_t > 8:
                ...
                if curr in ["sad", "angry", "fear"]:
                    self._ask(f"Child is {curr}. [HUG] Comfort immediately!")
            # Dashboard commands
            self._handle_cmd()

            # ── CONSCIOUS TASK EXECUTION ──────────────────────
            ...
            # Show tablet via signal
            self._show_tablet(task)

            # Announce task + gaze to tablet
            if task["domain"] == "Motor":
                self._say(task["instruction"] + " Look at the screen and do this!", wait=False)
                threading.Thread(target=self.a._gaze_tablet, daemon=True).start()
            else:
                self._say(task["instruction"] + " Click the correct one on the tablet!", wait=False)

            # Wait for response
            success = self._run_task(task)

            # ── CHECK RESPONSE (Conscious Logic) ─────────────
            if success:
                self._on_success(task)
                # Explicitly tell child we are moving to next task
                self._say(
                    f"{ST['name']}! "
                    f"{task.get('success_msg', 'Amazing! You did it! ✅')} "
                    f"[CELEBRATE] Now let us do the NEXT task! [NOD]",
                    wait=False)
            else:
                self._on_fail(task)
                # Stay on same task
                self._say(
                    f"{ST['name']}! "
                    f"{task.get('fail_msg', 'Not quite, try again!')} "
                    f"[THINK]",
                    wait=False)
            time.sleep(0.5)

    def _show_tablet(self, task):
        """Build data dict and emit signal — NEVER touch Qt directly"""
        ...
        if mode == "motor_model":
            ...
            data.update({
                ...
                "visual_hint": task.get("instruction", ""),
            })
        ST["tablet_click_result"] = None
        # SIGNAL — safe from any thread
        BRIDGE.sig_new_task.emit(data)

    def _run_task(self, task):
        """
        CONSCIOUS: stay on task until response confirmed.
        Give waiting prompts every ~6 seconds.
        """
        name = ST["name"]; vtype = task["verify"]
        prompts = task.get("prompts", ["Try again!"])
        waiting_msg = task.get("waiting_msg", "I am waiting for you!")
        ST["task_success"] = False; ST["last_speech_text"] = ""

        # Set motor verify
        motor_checks = ["clap","wave","raise_hand","touch_nose","arms_out","hands_up","head_tilt","blink"]
        if vtype == "motor" and task.get("motor_check") in motor_checks:
            ST["verify_action"] = task["motor_check"]
            ST["verify_result"] = False
            ST["verify_timeout"] = time.time() + 22

        deadline = time.time() + 60  # generous time
        last_prompt = time.time(); prompt_idx = 0

        while time.time() < deadline:
            # Check result
            result = self._check_result(task)
            if result == "success": return True
            if result == "fail": return False

            # Waiting prompt every 6s
            if time.time() - last_prompt > 6:
                last_prompt = time.time()
                if prompt_idx < len(prompts):
                    self.v.say(f"{name}... {prompts[prompt_idx]}", wait=False)
                    # Signal waiting text to tablet
                    BRIDGE.sig_set_waiting.emit(waiting_msg)
                    prompt_idx += 1
                else:
                    self.v.say(waiting_msg, wait=False)
                    BRIDGE.sig_set_waiting.emit(waiting_msg)
    ...
    def _check_result(self, task):
        """Return 'success', 'fail', or None (still waiting)"""
        vtype = task["verify"]
        if vtype == "motor":
            mc = task.get("motor_check", "")
            ...
            if mc == "blink" and ST["blinking"]: return "success"
            if mc == "head_tilt" and ST["head_tilted"]: return "success"
    ...
    def _on_success(self, task):
        ...
        # Show large ✅ via signal
        BRIDGE.sig_show_success.emit(task.get("success_msg", "Amazing! ✅"))
        # Joy animation via signal
        self.a.trigger_joy(task.get("joy", "celebrate"))
        # Update stats via signal
        BRIDGE.sig_update_stats.emit()
        LOG(f"✅ {ST['consecutive']}/3 '{task['id']}'", "success")

        # MASTERY GATE: 3 consecutive → unlock next task
        if ST["consecutive"] >= 3:
            ...
            self._ask(
                f"{name} earned 3 stars! MASTERED! [LEVEL_UP][CELEBRATE] "
                f"Moving to next task: '{next_t['instruction'][:25]}' [WAVE]")
            if task.get("reward") == "youtube":
                ST["youtube_pending"] = True
                self._ask(f"{name} earned a video reward! [CELEBRATE] What video? 🎬")
    ...
    def _on_fail(self, task):
        ST["consecutive"] = 0  # Reset mastery streak on fail
        ST["streak"] = 0; ST["tasks_fail"] += 1
        # Show ❌ via signal
        BRIDGE.sig_show_fail.emit(task.get("fail_msg", "Not quite! Try again!"))
        # Reset cards via signal after delay
    ...
    def _handle_cmd(self):
        ...
        ST["sim_cmd"] = None
        if cmd == "joy":
            self.a.trigger_joy("full_joy")
        elif cmd == "dance":
            self._ask("Dance! [DANCE][CELEBRATE]")
        elif cmd == "game":
            webbrowser.open(GAME_URL)
            self.v.say(f"Opening games {ST['name']}! 🎮", wait=False)
        elif cmd == "break":
    ...
    def _on_speech(self, text):
        ...
        if any(w in t for w in ["game", "play", "العب", "لعبة"]):
            webbrowser.open(GAME_URL)
            self.v.say(f"Opening games {name}! 🎮", wait=False); return
...
╠══════════════════════════════════════════════════════════════╣
║  CONSCIOUS TASK LOOP:                                       ║
║  ✅ Check response BEFORE moving to next task              ║
║  ✅ Large ✅ overlay on success                            ║
║  ✅ "Not quite, try again!" on fail — STAYS on task        ║
║  ✅ ALL Qt UI via pyqtSignal (zero threading errors)       ║
║  ✅ MediaPipe joint angles | energy=300 | 1.5-flash        ║
╠══════════════════════════════════════════════════════════════╣
║  Window 1: PyBullet FIXED | Window 2: Emotion RESIZABLE    ║
║  Window 3: Live RESIZABLE | Window 4: Tablet FIXED 740×960 ║
...
""")
    ...
    qt_app.setApplicationName("Pepper Smart Therapist")
    ...
    def _start():
        time.sleep(0.7)
        voice.say("Welcome to Pepper Smart Therapist! "
                  "Commander Lamya, all systems ready! "
                  "Conscious task loop active — I will check every response "
                  "before moving forward! Starting now!",
                  wait=False)
        if pepper:
    ...
    print(f"""
{'='*64}
✅ SMART THERAPIST ACTIVE — 4 WINDOWS
{'='*64}
Window 1: PyBullet    (FIXED — HeadPitch lip-sync)
Window 2: Emotion     (RESIZABLE — therapist)
Window 3: Live        (RESIZABLE — therapist)
...
Qt      → All via pyqtSignal (zero threading errors)
{'='*64}
Commands: stats | name X | next | skip | report | exit
{'='*64}
""")
            ...
            try:
                ...
                if cl in ["q","exit","quit"]:
                    ...
                    print(f"\n Child:{ST['name']} Level:{ST['current_level']} "
                          f"Domain:{ST['domain']} Mastery:{'★'*ST['consecutive']} {ST['consecutive']}/3 "
                          f"Mastered:{ST['tasks_mastered']} Score:{ST['score']}")
                elif cl in ["next","skip"]:
                    ST["consecutive"] = 0
                    ST["task_index"] = (ST["task_index"]+1) % len(TASKS)
                    voice.say("Skipping to next task!", wait=False)
