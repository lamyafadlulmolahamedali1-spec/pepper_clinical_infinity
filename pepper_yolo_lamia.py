#!/usr/bin/env python3
"""
Pepper with YOLO + Emotion Detection for Lamia
- Camera window with green bounding box
- Shows "Person: Lamia" and emotion
- Terminal shows emotion updates
...
PERSON_NAME = "Lamia"  # Your name

# ========== YOLO + Emotion Detection with Camera Window ==========
class VisionDetector:
    ...
    def start_camera(self):
        try:
            ...
            if not self.camera.isOpened():
                ...
                print("✅ Camera started! Window will open...")
    ...
    def detect_loop(self):
        while self.running:
            ...
            # Show camera window
            cv2.imshow('Pepper Vision - Person Detection', frame)
...
class PepperRobot:
    def __init__(self):
        ...
        print("\n" + "="*55)
        print(f"🤖 PEPPER with YOLO + Emotion Detection for {PERSON_NAME}")
        print("="*55)
