#!/usr/bin/env python3
"""
PEPPER COMPLETE - غرفة كاملة + أشخاص هندسيين + Pepper يرقص ويتحرك
بناء على الكود الناجح
"""
...
# ========== مجسم شخص بأشكال هندسية (زي ما طلبتي) ==========
class GeometricPerson:
    ...
    def create_person(self):
        """رأس دائرة + جسم مستطيل + يدين مستطيلين + رجلين مستطيلين"""
...
def create_full_room():
    """إنشاء غرفة بجدران وأثاث وبالونات"""
    ...
    while True:
        try:
            ...
            if cmd == 'q':
                ...
                speak("I see a room with walls, a table, chairs, a cabinet, a mirror, colorful balloons, and colorful geometric people walking around!")
            else:
...
# ========== الرئيسي ==========
print("="*60)
print("🤖 PEPPER COMPLETE - الغرفة الكاملة مع Pepper")
print("="*60)
...
# تشغيل qiBullet و Pepper (نفس الطريقة الناجحة)
...
# إنشاء أشخاص هندسيين (6 أشخاص بألوان مختلفة)
colors_list = [
    [1, 0.2, 0.2, 1],  # أحمر
    [0.2, 1, 0.2, 1],  # أخضر
    [0.2, 0.2, 1, 1],  # أزرق
...
for i in range(6):
    ...
    print(f"✅ شخص {i+1} (دائرة + مستطيلات) - لون {['أحمر','أخضر','أزرق','أصفر','برتقالي','بنفسجي'][i]}")
...
print("   🤖 Pepper في المنتصف")
print("   🎈 15 بالون طائر")
print("   🧑 6 أشخاص هندسيين يمشون")
print("   🪑 طاولة وكراسي في الجنب")
print("   🗄️ دولاب ومراية")
print("="*50 + "\n")

speak("Hello! I am Pepper! I am in the center of the room! Look at the colorful geometric people walking around me!")

# بدء التحكم
keyboard_control(pepper)
